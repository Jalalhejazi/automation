...
let ApiService = class ApiService {
    ...
    getCourses() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const url = _environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].api.courses;
    ...
    getCoursesByDate(date) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const url = `${_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].api.courses}?dato=${date}`;
            const response = yield fetch(url);
            const body = yield response.json();
            return body.KalenderList;
        });
    ...
    getCoursesThisMonth() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const url = `${_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].api.courses}?dato=${this.yyyyMM}`;
            const response = yield fetch(url);
            const body = yield response.json();
            return body.KalenderList;
        });
    ...
    getCoursesNextMonth() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const url = `${_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].api.courses}?dato=${this.NextM}`;
            const response = yield fetch(url);
            const body = yield response.json();
            return body.KalenderList;
        });
    ...
    getCourseInfo(courseNr) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const url = `${_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].api.courseInfo}?kursusNummer=${courseNr}&format=json`;
            const response = yield fetch(url);
            const body = yield response.json();
...
/* harmony import */ var _year_year_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./year/year.component */ "./src/app/year/year.component.ts");
/* harmony import */ var _product_info_product_info_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./product-info/product-info.component */ "./src/app/product-info/product-info.component.ts");
...
*/
let routes = [
    { path: service.Month, component: _current_current_component__WEBPACK_IMPORTED_MODULE_4__["CurrentComponent"], data: { dato: service.yyyyMM } },
    { path: service.Month_plus_1, component: _current_current_component__WEBPACK_IMPORTED_MODULE_4__["CurrentComponent"], data: { dato: service.NextM } },
    { path: service.Month_plus_2, component: _current_current_component__WEBPACK_IMPORTED_MODULE_4__["CurrentComponent"], data: { dato: service.NextMM } },
    { path: service.CurrentYear, component: _year_year_component__WEBPACK_IMPORTED_MODULE_8__["YearComponent"] },
    { path: 'kursus/:id', component: _product_info_product_info_component__WEBPACK_IMPORTED_MODULE_9__["ProductInfoComponent"] },
    ...
    { path: 'download', component: _download_download_component__WEBPACK_IMPORTED_MODULE_7__["DownloadComponent"] },
    { path: 'private/members',
        loadChildren: () => __webpack_require__.e(/*! import() | kursister-kursister-module */ "kursister-kursister-module").then(__webpack_require__.bind(null, /*! ./kursister/kursister.module */ "./src/app/kursister/kursister.module.ts")).then(m => m.KursisterModule)
    },
];
...
AppRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [],
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"].forRoot(routes, { enableTracing: false })],
...
/* harmony import */ var _head_head_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./head/head.component */ "./src/app/head/head.component.ts");
/* harmony import */ var _current_current_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./current/current.component */ "./src/app/current/current.component.ts");
...
/* harmony import */ var _download_download_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./download/download.component */ "./src/app/download/download.component.ts");
/* harmony import */ var _year_year_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./year/year.component */ "./src/app/year/year.component.ts");
...
/* harmony import */ var _pipes_date_as_iso_pipe__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./pipes/date-as-iso.pipe */ "./src/app/pipes/date-as-iso.pipe.ts");
...
/* harmony import */ var _product_info_product_info_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./product-info/product-info.component */ "./src/app/product-info/product-info.component.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _head_head_component__WEBPACK_IMPORTED_MODULE_5__["HeadComponent"],
            _service_service_component__WEBPACK_IMPORTED_MODULE_7__["ServiceComponent"],
            _contact_contact_component__WEBPACK_IMPORTED_MODULE_8__["ContactComponent"],
            _footer_footer_component__WEBPACK_IMPORTED_MODULE_9__["FooterComponent"],
            _download_download_component__WEBPACK_IMPORTED_MODULE_11__["DownloadComponent"],
            _current_current_component__WEBPACK_IMPORTED_MODULE_6__["CurrentComponent"],
            _year_year_component__WEBPACK_IMPORTED_MODULE_12__["YearComponent"],
...
let HeadComponent = class HeadComponent {
    ...
    ngOnInit() {
        ...
        this.description = `working with Angular ${_angular_core__WEBPACK_IMPORTED_MODULE_1__["VERSION"].full} and bootstrap together to build better webapps `;
    }
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DateAsISOPipe", function() { return DateAsISOPipe; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
DateAsISOPipe = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
let ProductInfoComponent = class ProductInfoComponent {
    ...
    ngOnInit() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this.kursus = yield this.service.getCourseInfo(id);
        });
    }
};
...
ProductInfoComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./product-info.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/product-info/product-info.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./product-info.component.css */ "./src/app/product-info/product-info.component.css")).default]
    })
...
let ProductComponent = class ProductComponent {
    ...
    ngOnInit() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const response = yield this.service.getCoursesByDate(this.date);
            this.data = yield response;
        });
    }
    moreInfo(selected) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
...
], ProductComponent.prototype, "date", void 0);
...
let YearComponent = class YearComponent {
    ...
    ngOnInit() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            let response = yield this.service.getCourses();
            this.data = response;
